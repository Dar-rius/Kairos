...
class Writer:
    ...
    def add(self, step, policy_loss:float, critic_loss:float, entropy_loss:float, belief_loss:float, loss:float, reward:float, pnl:float, p_value:float):
        ...
        self.writer.add_scalar("Portfolio Value", p_value, step)
